        ...
        transition("* <=> *", [
            ...
            group([
                ...
                query(":enter", [
                    ...
                    animate("0.4s", style({ transform: "scale(1) translateY(0%)" }))
                ], { optional: true }),

                query(":leave", [
                    style({ transform: "scale(1) translateY(0%)" }),
                    animate("0.4s", style({ transform: "scale(0) translateY(-100%)" }))
                ], { optional: true })
        ...
        transition("* <=> *", [
            ...
            group([
                ...
                query(":enter", [
                    ...
                    animate("0.4s", style({ transform: "scale(1) translateX(0%)" }))
                ], { optional: true }),

                query(":leave", [
                    style({ transform: "scale(1) translateX(0%)" }),
                    animate("0.4s", style({ transform: "scale(0) translateX(-100%)" }))
                ], { optional: true })
